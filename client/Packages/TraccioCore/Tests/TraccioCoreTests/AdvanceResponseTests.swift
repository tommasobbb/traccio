...
struct AdvanceResponseTests {
          ...
          "advances": [
            {
              ...
              "status": "open",
              "participants": [
                { "name": "Marco", "expected_amount": 1800 },
                { "name": "Giulia", "expected_amount": 1800 }
              ],
    ...
    @Test func decodesEnvelopePreservingFieldsAndParticipants() throws {
        ...
        #expect(advance.participants[0].name == "Marco")
        #expect(advance.participants[0].expectedAmount == 1800)
    }
